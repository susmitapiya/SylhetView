...
public class Bus_Station1 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bus__station1);
        ...
        if (id == 1) {
            ...
            chobi.setImageResource(R.drawable.kodomtoli);
            cname.setText(st1);
            add.setText(st2);
            phn.setText(st3);
            phone.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent1.setData(Uri.parse("tel: " + "+880 1717-257439"));
        ...
        if (id == 2) {
            ...
            chobi.setImageResource(R.drawable.kumragowbus);
            cname.setText(st1);
            add.setText(st2);
            phn.setText(st3);
            ...
            phone.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent1 = new Intent(Intent.ACTION_DIAL);
                    intent1.setData(Uri.parse("tel: " + "0000000"));
                    startActivity(intent1);
